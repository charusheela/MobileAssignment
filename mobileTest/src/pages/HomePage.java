...
public class HomePage extends Base{
	...
	public HomePage verifyHomePage() {
		...
		try {
			waitForPageToLoad();
			TestReporter.AssertTrueWithScreenshot(search_Box.isDisplayed(),"Verify Home page is loaded successfully");
	...
	public HomePage EnterKeyword_SearchItem() {
		...
		select_Product.click(); //Selecting product from auto suggestion
